...
class Program
{
    ...
    {
        ApplicationLicense st1 = new ApplicationLicense("Триальный режим", "Безкоштовний режим", "Платна версія");
        Console.WriteLine("Екземпляр st1:");
        st1.Print();
        License lic1 = new License(st1.allowTrial, st1.allowCommon, st1.allowPro, "Виберіть ліцензію :");
        Console.WriteLine("Екземпляр lic1:");
        lic1.Print();
    }
}
